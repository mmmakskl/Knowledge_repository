module md5(data_o,data_i,newtext_i,ready_o,load_i,reset,clk);
output [127:0] data_o;
input [127:0] data_i;
input newtext_i;
output ready_o;
...
always @(func_out or message or round or dr or cr or br or ar or t )
   begin
   ...
   auxfuncs=(ar +fr_varfuncs+message_varfuncs[nblockfuncs]+tr_varfuncs);
    ...
    //cout <<round64 .read () <<<<fr_var <<<<aux <<<<nblock <<<<message_var [ nblock ] <<endl ;
...
//round64FSM:
always @(D or C or B or A or getdata_state or func_out or generate_hash or dr or cr or br or ar or round64 or round or newtext_i )
   begin
...
always @(generate_hash or dr or cr or br or ar or D or C or B or A or func_out or message or hash_generated or getdata_state or load_i or data_i or newtext_i )
   begin
