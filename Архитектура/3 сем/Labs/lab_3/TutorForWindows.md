Открываем ASMTool, Файл->Новый, пишем программу, после сохраняем и компилируем и запускаем через шестеренку с молотком(вторая сверху): ![[swappy-20241013-144641.png]]
